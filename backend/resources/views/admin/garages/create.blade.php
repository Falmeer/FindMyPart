...
@section('breadcrumb', 'Garages / Create')

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h3 class="font-semibold text-gray-900 mb-6">New Garage Account</h3>
        ...
        <form method="POST" action="{{ route('admin.garages.store') }}" class="space-y-6">
            ...
            <fieldset class="border border-gray-200 rounded-lg p-4 space-y-4">
                <legend class="text-sm font-semibold text-gray-700 px-2">Garage Details</legend>
                <div>
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.garages.index') }}" class="px-5 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm hover:bg-gray-50">Cancel</a>
                <button type="submit" class="px-5 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">Create Garage</button>
            </div>
        </form>
    </div>
</div>
